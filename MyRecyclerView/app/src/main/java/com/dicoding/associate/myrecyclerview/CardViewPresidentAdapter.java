package com.dicoding.associate.myrecyclerview;
...
public CardViewViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        (R.layout.item_cardview_president, viewGroup, false);
...
public void onItemClicked(View view, int position) {
        Toast.makeText(context, "Favorite "+getListPresident().
...
@Override
public void onItemClicked(View view, int position) {
        Toast.makeText(context, "Share "+getListPresident().get
